...
class InventoryTransactionApi {
  ...
  Future<Response<BuiltList<InventoryTransactionResponse>>> inventoryTransactionGet({ 
    ...
    final _path = r'/InventoryTransaction';
    ...
    BuiltList<InventoryTransactionResponse>? _responseData;
    ...
    return Response<BuiltList<InventoryTransactionResponse>>(
      data: _responseData,
  ...
  Future<Response<InventoryTransactionResponse>> inventoryTransactionIdGet({ 
    ...
    InventoryTransactionResponse? _responseData;
    ...
    return Response<InventoryTransactionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<InventoryTransaction>> inventoryTransactionPost({ 
    ...
    InventoryTransaction? _responseData;
    ...
    return Response<InventoryTransaction>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
